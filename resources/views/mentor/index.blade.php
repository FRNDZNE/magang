    ...
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('mentors.create') }}" class="btn btn-primary mb-3">
                <i class="bi bi-plus"></i> Tambah Mentor
            </a>
                ...
                <tbody>
                    @forelse ($mentors as $m)
                        <tr>
                            ...
                            <td>
                                {{-- Button Detail --}}
                                <a href="{{ route('mentors.show', $m->user->uuid) }}" class="btn btn-md btn-info"><i
                                        class="bi bi-eye"></i></a>
                                {{-- End Button Detail --}}

                                {{-- Button Edit --}}
                                <a href="{{ route('mentors.edit', $m->user->uuid) }}" class="btn btn-md btn-warning"><i
                                ...
                                <button type="button" class="btn btn-danger btn-md-danger" data-bs-toggle="modal"
                                    data-bs-target="#modalId-{{ $m->user->uuid }}">
                                    <i class="bi bi-trash"></i>
                                </button>

                                <!-- Modal Body -->
                                <!-- if you want to close by clicking outside the modal, delete the last endpoint:data-bs-backdrop and data-bs-keyboard -->
                                <div class="modal fade" id="modalId-{{ $m->user->uuid }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('mentors.destroy', $m->user->uuid) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
