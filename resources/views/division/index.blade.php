                ...
                <tbody>
                    @forelse ($division as $d)
                        <tr>
                            ...
                            <td>
                                {{-- Button Detail --}}
                                <a href="{{ route('divisions.show', $d->id) }}" class="btn btn-md btn-info"><i
                                        class="bi bi-eye"></i></a>
                                {{-- End Button Detail --}}

                                {{-- Button Edit --}}
                                <a href="{{ route('divisions.edit', $d->id) }}" class="btn btn-md btn-warning"><i
                                ...
                                <div class="modal fade" id="modalId-{{ $d->id }}" tabindex="-1"
